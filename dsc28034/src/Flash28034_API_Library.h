#ifndef FLASH28034_API_LIBRARY_H
...
#define FLASH_START_ADDR 0x700000
#define FLASH_END_ADDR   0x740000

#define Flash28034_APIVersionHex (Uint16 (*)(void))0x7fe3e4
#define Flash28034_Program (Uint16 (*)(Uint32 *FlashAddr, Uint32*BufAddr, Uint32 Length, FLASH_ST *FProgStatus))0x7fde00
#define Flash28034_ChipErase (Uint16 (*)(FLASH_ST *FEraseStat))0x7fe21e
#define Flash28034_ChipEraseLast (Uint16 (*)(FLASH_ST *FEraseStat))0x7fe2e8
#define Flash28034_Verify (Uint16 (*)(Uint32 *FlashAddr, Uint32 *BufAddr, Uint32 Length, FLASH_ST *FVerifyStat))0x7fdf24
#define Flash28034_ProgVerify (Uint16 (*)(Uint32 *FlashAddr, Uint32 Length, FLASH_ST *FVerifyStat))0x7fdef6
#define Flash28034_Erase (Uint16 (*)(Uint64 SectorMask, FLASH_ST *FEraseStat))0x7fe09a
#define Flash28034_EraseVerify (Uint16 (*)(Uint32 *FlashAddr, Uint32 Length, FLASH_ST *FVerifyStat))0x7fe06C
